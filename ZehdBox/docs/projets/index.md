...
# <span class="h1">Mes Projets</span>

<p class="intro">
    Une sélection de projets réalisés à l'école 42 : du jeu 2D au serveur IRC, en passant par le Pong multijoueur.
</p>
...
-   :material-sort:{ .lg .middle } __Push Swap__
    ...
    **Algorithme de tri** optimisé en C : deux piles, un nombre minimal d'opérations.
    ...
    [:octicons-arrow-right-24: Découvrir](push_swap.md)

-   :material-chess-rook:{ .lg .middle } __So Long__
